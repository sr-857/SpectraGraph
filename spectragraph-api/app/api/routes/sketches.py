...
from spectragraph_core.utils import flatten
from sqlalchemy.orm import Session
from app.api.schemas.sketch import SketchCreate, SketchRead, SketchUpdate
from spectragraph_core.core.models import Sketch, Profile
...
async def get_sketch_nodes(
    ...
    if format == "inline":
        from spectragraph_core.utils import get_inline_relationships
